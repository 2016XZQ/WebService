 ...
 * generated in the com.black.tea package. 
...
public class ObjectFactory {
    ...
    private final static QName _QueryWeather_QNAME = new QName("http://server.tea.black.com/", "QueryWeather");
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://server.tea.black.com/", "QueryWeatherResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.black.tea
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.tea.black.com/", name = "QueryWeather")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.tea.black.com/", name = "QueryWeatherResponse")
