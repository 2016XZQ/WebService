 ...
 * 2018-04-13T16:39:42.380+08:00
 * Generated source version: 3.2.4
 *
 */
@WebServiceClient(name = "WeatherInterfaceService",
                  wsdlLocation = "http://localhost:8080/ws/weather?wsdl",
                  targetNamespace = "http://server.tea.black.com/")
public class WeatherInterfaceService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://server.tea.black.com/", "WeatherInterfaceService");
    public final static QName WeatherInterfacePort = new QName("http://server.tea.black.com/", "WeatherInterfacePort");
    static {
        URL url = null;
        try {
