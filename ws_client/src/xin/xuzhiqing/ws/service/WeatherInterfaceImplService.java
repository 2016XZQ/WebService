 ...
 * 
 */
@WebServiceClient(name = "WeatherInterfaceImplService", targetNamespace = "http://server.ws.xuzhiqing.xin/", wsdlLocation = "http://localhost:54321/weather?WSDL")
    ...
    extends Service
{
    ...
    private final static QName WEATHERINTERFACEIMPLSERVICE_QNAME = new QName("http://server.ws.xuzhiqing.xin/", "WeatherInterfaceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:54321/weather?WSDL");
    ...
    public WeatherInterfaceImpl getWeatherInterfaceImplPort() {
        return super.getPort(new QName("http://server.ws.xuzhiqing.xin/", "WeatherInterfaceImplPort"), WeatherInterfaceImpl.class);
    }
    ...
    public WeatherInterfaceImpl getWeatherInterfaceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.ws.xuzhiqing.xin/", "WeatherInterfaceImplPort"), WeatherInterfaceImpl.class, features);
    }
