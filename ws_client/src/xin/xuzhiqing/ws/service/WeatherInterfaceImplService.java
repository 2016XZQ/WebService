 ...
 * 
 */
@WebServiceClient(name = "WeatherInterfaceImplService", targetNamespace = "http://server.ws.xuzhiqing.xin/", wsdlLocation = "http://localhost:1997/weather?WSDL")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:1997/weather?WSDL");
