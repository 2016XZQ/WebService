...
package xin.xuzhiqing.ws.service;
 ...
 * generated in the xin.xuzhiqing.ws.server package. 
...
public class ObjectFactory {
    ...
    private final static QName _QueryWeather_QNAME = new QName("http://server.ws.xuzhiqing.xin/", "queryWeather");
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://server.ws.xuzhiqing.xin/", "queryWeatherResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: xin.xuzhiqing.ws.server
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.ws.xuzhiqing.xin/", name = "queryWeather")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.ws.xuzhiqing.xin/", name = "queryWeatherResponse")
