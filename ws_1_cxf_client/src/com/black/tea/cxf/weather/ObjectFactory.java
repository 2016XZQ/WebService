 ...
 * generated in the com.black.tea.cxf.weather package. 
...
public class ObjectFactory {
    ...
    private final static QName _QueryWeather_QNAME = new QName("http://server.cxf.tea.black.com/", "QueryWeather");
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://server.cxf.tea.black.com/", "QueryWeatherResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.black.tea.cxf.weather
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.cxf.tea.black.com/", name = "QueryWeather")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.cxf.tea.black.com/", name = "QueryWeatherResponse")
